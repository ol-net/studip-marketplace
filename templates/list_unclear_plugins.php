...
<TABLE BORDER=0 WIDTH="100%" CELLSPACING=0>
  <TR CLASS="topic">
<? foreach (array('Username','Plugin Name','Action') as $t) : ?>
...
<? $css->switchClass(); ?>
  <TR CLASS="<?=$css->getClass()?>" <?=$css->getHover()?>>
    ...
    <TD CLASS="<?=$css->getClass()?>" STYLE="width:30px; max-width:30px;"><IMG <?=makeButton('edit','src')?> onClick="location.href='?dispatch=edit_plugin&plugin_id=<?=$p->getPluginId()?>';"></TD>
  </TR>
<? endforeach ?>
</TABLE>
