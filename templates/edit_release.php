...
<DIV CLASS="topic">Edit Release</DIV>
<TABLE BORDER=0 WIDTH="100%">
  ...
  <!--
  <TR>
    <TD STYLE="width:150px; vertical-align:top; font-weight:bold;">Matterhorn Min-Version: </TD>
  ...
  <TR>
    <TD STYLE="width:150px; vertical-align:top; font-weight:bold;">Matterhorn Max-Version: </TD>
  ...
  -->
  <TR>
    <TD STYLE="width:150px; vertical-align:top; font-weight:bold;">Release Type: </TD>
    <TD>
...
<? endif ?>
  ...
  <TR>
    <TD STYLE="width:150px; vertical-align:top; font-weight:bold;">File (ZIP-File): </TD>
    <TD><INPUT TYPE="file" NAME="releasefile" ID="releasefile" SIZE="45" style="width:400px"></TD>
  </TR>
  <TR>
    <TD STYLE="width:150px; vertical-align:top; font-weight:bold;">Previous File: </TD>
    <TD><?=htmlReady($f->getFileName())?></TD>
  </TR>
<? if ($r->getReleaseId()) : ?>
  <TR>
    <TD COLSPAN=2>
      <DIV CLASS="topic" STYLE="margin-top:10px;">Dependencies:</DIV>
      <TABLE BORDER=0 WIDTH="100%">
        <TR>
          <TD WIDTH="33%" STYLE="vertical-align:top;">
            <DIV CLASS="category_head">Please select Plugin:</DIV>
            <DIV ID="available_plugins"><CENTER><IMG SRC="images/wait24trans.gif"></DIV>
          </TD>
          <TD WIDTH="33%" STYLE="vertical-align:top;">
            <DIV CLASS="category_head">Please select Release:</DIV>
...
<? endif ?>
  ...
  <TR>
    <TD COLSPAN=2 STYLE="text-align:center;"><INPUT TYPE="image" <?=makeButton('save','src')?>> <IMG <?=makeButton('abort','src')?> onClick="location.href='?dispatch=edit_plugin&plugin_id=<?=$r->getPluginId()?>'"> <? if ($r->getReleaseId()) : ?><IMG <?=makeButton('delete','src')?> onClick="if (confirm('Do you really want delete this release?')){location.href='?dispatch=remove_release&release_id=<?=$r->getReleaseId()?>&plugin_id=<?=$r->getPluginId()?>';}"><? endif ?></TD>
  </TR>
</TABLE>
<SPAN STYLE="color:red; font-weight:bold;">*</SPAN> = Data will be copied from the manifest.
</FORM>
